...
int oLedRED = 7; // Iesire led butoon rosu
int oLedGREEN = 6; // Iesire led buton verde 
int oLedBLUE = 5; // Iesire led buton albastru
int oCharger = 13; // Iesire oCharger telefon
int oTurnLeft = 3; // Iesire semnal stanga
int oTurnRight = A5; // Iesire semnal dreapta
int oPositionLeft = 4; // Iesire pozitie semnal stanga
int oPositionRight = 2; // Iesire pozitie semnal dreapta
int oLoudHorn = 12; // Iesire

int iSmartButton = A4;  // Intrare switch rgb
int iTurnLeft = A2; // Intrare switch semnalizare Mate
int iTurnRight = A3; // Intrare switch semnalizare Mate
int iHorn = A1; // Intrare claxon / horn
// int liberIn2 = A0; // Intrare
// int liberIn3 = A7; // Intrare
